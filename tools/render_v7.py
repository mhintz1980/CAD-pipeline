...
def shoot(name, loc, tgt, ortho=None):
    ...
    print("rendered", name)
shoot("v7-iso",       (5.2, -5.6, 3.6), (0.0, 0.2, 0.4))
shoot("v7-side",      (9.0,  0.0, 0.35), (0.0, 0.0, 0.35), ortho=5.6)
shoot("v7-top",       (0.059, 0.0, 9.0), (0.059, 0.0, 0.0), ortho=5.6)
shoot("v7-junction",  (3.4,  3.0, 1.5), (0.06, 0.75, 0.1))
shoot("v7-pumpend",   (5.0,  4.2, 1.2), (0.06, 1.3, 0.1))
print("DONE")
